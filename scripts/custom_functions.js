...
fns.shouldPerfectProxy = function(environment, data) {
  ...
  // let shouldPP = Object.keys(data.pageType).length === 0 || data.pageType.passthrough === "perfectProxy" || environment.path.indexOf("moovperfectproxy=true") > -1;
  let shouldPP = data.pageType.passthrough === "perfectProxy" || environment.path.indexOf("moovperfectproxy=true") > -1; // TEMP solution
